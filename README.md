...
Publishing is handled by the manual `Publish Package` GitHub Actions workflow. It normalizes the package name to the unscoped npm name, then reruns the full gate before `npm publish --provenance`.
