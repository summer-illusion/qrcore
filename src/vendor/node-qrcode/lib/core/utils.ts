type ToSJISFunction = (kanji: string) => number

let toSJISFunction: ToSJISFunction | undefined

const CODEWORDS_COUNT = [
  0,
  26, 44, 70, 100, 134, 172, 196, 242, 292, 346, 404, 466, 532,
...
export function getSymbolTotalCodewords(version: number): number | undefined {
...
export function setToSJISFunction(f: ToSJISFunction): void {
